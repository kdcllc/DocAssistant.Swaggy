...
public class DocumentResponse(string name, string contentType, long size, DateTimeOffset? lastModified, Uri url, DocumentProcessingStatus status, EmbeddingType embeddingType, string userGroups)
{
